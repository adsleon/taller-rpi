...
- Indicar los pines GPIO recomendados y resistencias en la práctica del laboratorio.
- Añadir ejemplos de código (scripts Python) en la carpeta `src/` para cada etapa.
